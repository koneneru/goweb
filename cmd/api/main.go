...
func main() {
	...
	flag.BoolVar(&cfg.limiter.enabled, "limiter-enabled", true, "Enable rate liiter")

	flag.StringVar(&cfg.smtp.host, "smtp-host", "smtp.freesmtpservers.com", "SMTP host")
	flag.IntVar(&cfg.smtp.port, "smtp-port", 25, "SMTP port")
	flag.StringVar(&cfg.smtp.username, "smtp-username", "", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Goweb <no-reply@goweb.com>", "SMTP sender")
